...
class SequentialRecommender(AbstractRecommender):
    ...
    def __init__(self, config, dataset):
        ...
        # Test-time embedding noise injection settings
        self.enable_test_embedding_noise = config['enable_test_embedding_noise']
        self.test_embedding_noise_scale = config['test_embedding_noise_scale']
        self.test_embedding_noise_type = config['test_embedding_noise_type']
